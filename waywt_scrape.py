...
page_url = [str(i) for i in range(2489, 2787)]
...
for page in page_url:
    url = "https://www.styleforum.net/threads/the-what-are-you-wearing-today-waywt-discussion-thread-part-ii.394687/page-" + str(page)
    ...
    # Get date and time of each post
